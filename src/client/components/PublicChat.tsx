                  ...
                  <div className="chat-room-list">
                    {spreadsheets.length === 0 ? (
                      <div className="chat-empty">
                        ...
                        <small>
                          Chat rooms will appear when spreadsheets are linked.
                        </small>
                      </div>
                    ) : (
                      spreadsheets.map((spreadsheet) => {
                        const isAdminRoom =
                          spreadsheet.spreadsheet_id === '__ADMIN_ONLY__';
                        return (
                          <button
                      ...
                      <div className="chat-settings-field">
                        ...
                        {isAdmin && (
                          <small className="admin-note">
                            Admin names are set from your Google account and
                            cannot be changed.
                          </small>
                        )}
                      </div>
