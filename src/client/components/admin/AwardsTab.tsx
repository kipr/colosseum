      ...
      {!selectedEventId ? (
        ...
        <div className="card">
          ...
          >
            ...
            placement, per-bracket overall, seeding). Configure top-N counts in
            the modal. They are stored as event awards whose names start with
            &quot;Auto:&quot;; applying replaces previous automatic awards with
            a fresh calculation.
          </p>
